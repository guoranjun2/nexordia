...
```
. (git repository root - where Codex starts)
...
- **EXPECT Codex to urge** this approach and take the suggestions seriously
...
**For any automated translation work (Codex, translation tools), ALWAYS validate after editing .properties files:**
