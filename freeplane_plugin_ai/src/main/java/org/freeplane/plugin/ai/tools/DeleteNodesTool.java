...
public class DeleteNodesTool {
    ...
    ToolCallSummary buildToolCallSummary(DeleteNodesRequest request, DeleteNodesResponse response) {
        return new ToolCallSummary("deleteNodes",
            "deleteNodes: " + request.getUserSummary(), false);
    }

    ToolCallSummary buildToolCallErrorSummary(DeleteNodesRequest request, RuntimeException error) {
