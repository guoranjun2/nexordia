...
public class PaintPerformanceMonitor {
	...
	private static class Frame {
		...
		String report(long frameNumber) {
			final StringBuilder builder = new StringBuilder("paint performance frame ");
			builder.append(frameNumber).append(": total=").append(toMillis(totalNanos)).append("ms");
